...
<style>
  .teaching-inspector{border:1px solid var(--archon-border,var(--border));border-radius:.9rem;background:var(--archon-surface,#0f172a);padding:1rem;box-shadow:0 12px 30px rgba(0,0,0,.26)}
  header{border-left:4px solid var(--archon-orange,#f59e0b);padding-left:.85rem}h4{margin:.35rem 0;color:var(--archon-text,#f8fafc);font-size:1.18rem}.summary{margin:.3rem 0 0;color:var(--archon-text-secondary,#cbd5e1);font-size:.86rem;line-height:1.55}.teaching-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.7rem;margin-top:1rem}.teaching-grid section,.module-detail{border:1px solid #2b3b50;border-radius:.65rem;background:var(--archon-surface-raised,#111c2e);padding:.8rem}.teaching-grid .wide{grid-column:1/-1}.teaching-grid .failure{border-color:color-mix(in srgb,var(--archon-coral,#fb7185) 50%,#2b3b50)}.teaching-grid .why{border-color:color-mix(in srgb,var(--archon-orange,#f59e0b) 62%,#2b3b50);box-shadow:0 0 18px var(--archon-orange-glow,rgba(245,158,11,.16))}.teaching-grid h5,.module-detail h5{margin:0 0 .38rem;color:var(--archon-orange,#f59e0b);font-size:.68rem;letter-spacing:.09em;text-transform:uppercase}.teaching-grid p,.module-detail p{margin:0;color:var(--archon-text-secondary,#cbd5e1);font-size:.78rem;line-height:1.58}.teaching-grid ul{display:grid;gap:.3rem;margin:0;padding-left:1.1rem;color:var(--archon-text-secondary,#cbd5e1);font-size:.76rem;line-height:1.5}.module-detail{margin-top:1rem;border-color:color-mix(in srgb,var(--archon-orange,#f59e0b) 58%,#2b3b50)}@media(max-width:620px){.teaching-grid{grid-template-columns:1fr}.teaching-grid .wide{grid-column:auto}}
</style>
