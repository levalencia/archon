...
<section class="deck" aria-label="Slide presentation">
  ...
  <article role="group" aria-roledescription="slide" aria-label={`Slide ${index + 1} of ${content.slides.length}`}>
    <span class="eyebrow">Archon request lifecycle</span>
    <h3>{slide.title}</h3>
