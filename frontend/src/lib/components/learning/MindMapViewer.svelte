...
<style>.mind-map{border:1px solid var(--border);border-radius:1rem;background:var(--cogentrex-canvas,#050712);padding:1rem}.mind-map header{margin-bottom:1rem}.mind-map h3{font-size:1.7rem;margin:.4rem 0}.mind-map header p{margin:.35rem 0;color:var(--secondary);line-height:1.6}.branch-picker{display:flex;align-items:center;gap:.4rem;flex-wrap:wrap;margin-bottom:.8rem}.branch-picker>span{color:var(--muted);font:700 .65rem var(--font-mono);text-transform:uppercase;margin-right:.35rem}.branch-picker button{border:1px solid var(--border);border-radius:999px;background:var(--panel);color:var(--secondary);padding:.45rem .65rem;font-size:.7rem}.branch-picker button[aria-pressed="true"]{border-color:var(--accent);background:var(--accent-glow);color:var(--accent);box-shadow:0 0 14px var(--cogentrex-orange-glow)}@media(max-width:600px){.branch-picker{align-items:stretch}.branch-picker>span{width:100%}}
</style>
