<script lang="ts">
  ...
  async function downloadExport() {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `cogentrex-run-${runId}.json`;
      anchor.click();
