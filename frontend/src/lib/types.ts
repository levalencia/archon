...
export interface ToolCall { tool: string; parameters?: Record<string, unknown>; result?: unknown; status?: string }
export interface Skill { name: string; description?: string }
export interface ThinkingStep { type: string; detail: string; done?: boolean }
...
export interface Message {
  ...
  sources?: Array<{ title: string; score?: number }>; artifacts?: Artifact[];
