...
The course mapping still has educational value, but it is not a completion score. The detailed reclassification in [Feature and Course Concept Audit v2](FEATURE-AND-COURSE-AUDIT-V2.md) found:
