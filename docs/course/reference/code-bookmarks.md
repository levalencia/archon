...
> **Current-revision boundary:** source and exact test symbols checked for the local Skills/Instructions/MCP documentation candidate based at `a642952`. Links target files because line numbers drift; search the exact symbol after opening. Revalidate names after rebases. Candidate documentation is not a final gate result.
...
| Instruction loading and precedence | [`instructions/loaders.py::load_project_instructions`](../../../backend/app/instructions/loaders.py) → [`instructions/resolver.py::resolve_effective_context`](../../../backend/app/instructions/resolver.py) | [`test_instruction_loaders.py`](../../../backend/tests/unit/test_instruction_loaders.py), [`test_instruction_precedence.py`](../../../backend/tests/unit/test_instruction_precedence.py) |
| Immutable instruction/skill context | [`skills/persistence.py::ProjectInstructionRepository`, `SkillRepository`](../../../backend/app/skills/persistence.py) → [`skills/context.py::EffectiveContextEnrichmentService.enrich`](../../../backend/app/skills/context.py) | [`test_instruction_snapshots.py`](../../../backend/tests/unit/test_instruction_snapshots.py), [`test_skill_discovery_enrichment.py`](../../../backend/tests/unit/test_skill_discovery_enrichment.py) |
| Capability selection and provenance | [`capabilities/selector.py::select_capabilities`](../../../backend/app/capabilities/selector.py) → [`runtime/context_provenance.py::EffectiveContextManifest`](../../../backend/app/runtime/context_provenance.py) | [`test_capability_selector.py`](../../../backend/tests/unit/test_capability_selector.py), [`test_context_provenance.py`](../../../backend/tests/unit/test_context_provenance.py) |
| MCP runtime and transports | [`mcp/runtime.py::MCPRuntimeToolProvider`](../../../backend/app/mcp/runtime.py) → [`mcp/client.py::create_mcp_client`](../../../backend/app/mcp/client.py) | [`test_mcp_runtime.py`](../../../backend/tests/integration/test_mcp_runtime.py), [`test_mcp_remote_client.py`](../../../backend/tests/unit/test_mcp_remote_client.py), [`test_mcp_transport_governance.py`](../../../backend/tests/integration/test_mcp_transport_governance.py) |
